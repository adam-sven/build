  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative mx-auto w-full max-w-6xl px-4 pb-14 pt-16 md:px-8 md:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/discover"
              className="inline-flex items-center gap-2 rounded-lg border border-cyan-300/50 bg-cyan-300 px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-cyan-200"
            >
              Open Discover
            ...
            <Link
              href="/smart"
              className="inline-flex items-center gap-2 rounded-lg border border-cyan-300/30 bg-cyan-400/10 px-4 py-2 text-sm font-semibold text-cyan-200 hover:bg-cyan-400/20"
            >
              Open Smart Wallets
            </Link>
            <Link
              href="/intel"
              className="inline-flex items-center gap-2 rounded-lg border border-white/20 bg-black/35 px-4 py-2 text-sm font-semibold text-white/85 hover:border-cyan-300/35 hover:text-cyan-200"
            >
              Open Intel
            </Link>
          </div>
      ...
      <section className="relative mx-auto w-full max-w-6xl px-4 md:px-8">
        <div className="grid gap-3 md:grid-cols-3">
          {corePillars.map((item) => {
            ...
            return (
              <div key={item.title} className="rounded-xl border border-cyan-400/20 bg-[#060b14]/80 p-5">
      ...
      <section className="relative mx-auto mt-14 w-full max-w-6xl px-4 md:px-8">
        <div className="rounded-2xl border border-cyan-400/20 bg-[#050912]/90 p-6 md:p-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <Link
              href="/api-docs"
              className="inline-flex items-center gap-2 self-start rounded-lg border border-cyan-300/35 bg-cyan-400/10 px-3 py-2 text-xs font-semibold text-cyan-200 hover:bg-cyan-400/20"
            >
              API Docs
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-3">
            {steps.map((step, idx) => (
              <div key={step.title} className="rounded-xl border border-white/10 bg-black/30 p-4">
      ...
      <section className="relative mx-auto mt-14 w-full max-w-6xl px-4 pb-20 md:px-8">
        ...
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
          {checks.map((item) => (
            <div key={item} className="rounded-lg border border-white/10 bg-black/30 p-3 text-sm text-white/80">
              {item}
            </div>
          ))}
        </div>
